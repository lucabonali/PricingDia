...
for e in range(n_experiments):
    ...
    agg_ts_learner = SWUCB1_Learner(n_arms=n_arms, margins=margins, classes = [0, 1, 2])
    cl0_ts_learner = SWUCB1_Learner(n_arms=n_arms, margins=margins, classes = [0])
    cl1_ts_learner = SWUCB1_Learner(n_arms=n_arms, margins=margins, classes = [1])
    cl2_ts_learner = SWUCB1_Learner(n_arms=n_arms, margins=margins, classes = [2])
    cl01_ts_learner = SWUCB1_Learner(n_arms=n_arms, margins=margins, classes = [0, 1])
    cl02_ts_learner = SWUCB1_Learner(n_arms=n_arms, margins=margins, classes = [0, 2])
    cl12_ts_learner = SWUCB1_Learner(n_arms=n_arms, margins=margins, classes = [1, 2])
