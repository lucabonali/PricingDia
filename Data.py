...
first_curve_values = [
    ...
    [[0.9, 0.87, 0.87, 0.85, 0.5, 0.3, 0.25, 0.2, 0.18, 0.03, 0.01, 0.01, 0.01, 0, 0, 0, 0, 0, 0],
     [0, 100, 200, 300, 400, 500, 550, 600, 650, 700, 750, 800, 850, 900, 1000, 1100, 1200, 1300,
      1400]]]  # new model feb mar apr
...
def get_class_probabilities(n_class):
    res = []
    for p in range(len(classes_curve_values[n_class])):
        res.append(classes_curve_values[n_class][p][0])
    return res
